...
def conectarMongoDB(host="localhost", puerto=27017, nombreBD="trafico_replica"):
...
def main():
    ...
    bd = conectarMongoDB()
    print("[BD Réplica] Esperando eventos...")
    ...
    while True:
        try:
            ...
            print(f"[BD Réplica] Guardado: {resultado.inserted_id}")
